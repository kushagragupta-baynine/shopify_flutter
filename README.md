...
> `storefrontApiVersion` default vesion is set to '2026-04'
...
For more information about filters visit:
  ...
  2. https://shopify.dev/docs/api/storefront/2026-04/input-objects/productfilter
